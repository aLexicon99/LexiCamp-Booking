...
export default function HeroSearch() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-3 rounded-2xl bg-white/95 p-3 shadow-2xl md:flex-row md:items-center md:gap-2">
      <div className="grid w-full flex-1 grid-cols-1 gap-3 px-2 py-2 sm:grid-cols-3 md:gap-2 md:px-4">
        <div className="flex min-w-0 flex-col items-start text-left">
          ...
          <input
            className="min-h-10 w-full border-none p-1 text-sm font-semibold text-stone-800 placeholder:text-stone-300 focus:border-transparent focus:outline-none focus:ring-0 sm:text-base"
